    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseo" class="collapse" aria-labelledby="headingo" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="<?php echo e(url('/borrow')); ?>">Lend a Book</a>
            <a class="collapse-item" href="<?php echo e(url('/return')); ?>">Return a Book</a>
          <a class="collapse-item" href="<?php echo e(url('/viewborrow')); ?>">Borrow details</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo e(url('/addBook')); ?>">Add Books</a>
            <a class="collapse-item" href="<?php echo e(url('/manageBook')); ?>">Manage Books</a>
            <a class="collapse-item" href="<?php echo e(url('/categories')); ?>">Categories</a>
          </div>
        </div>
      </li>
